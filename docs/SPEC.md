...
| Kit compaction (inherited) | `compaction.thresholdPercent` — and now on demand: `Runner.Compact` calls Kit's public `Compact` | [Default Harness](https://eve.dev/docs/concepts/default-harness) |
